...
<body>
	<div class="d-flex justify-content-center">
		...
		<div class="form-group">
			<label for="name">Seat Name</label> <input
				type="text" class="form-control" id="name" name="name" required
				value='${model.name}'>
		</div>
		<div class="form-group">
			<label for="code">Seat Code</label> <input
		...
		<button type="submit" id="btnAddOrUpdate" class="btn btn-primary pl-3 pr-3">Save</button>
	</form>
	</div>
				...
				.ajax({
					...
					success : function(result) {
						swal({
						 ...
						 function(isConfirm){
						   if (isConfirm){
							   window.location.href = "/admin/save-seat";	
						    }
						 });
					},
